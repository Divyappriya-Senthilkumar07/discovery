  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-200 dark:border-slate-800/80 pb-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2.5 rounded-xl bg-gradient-to-tr from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 text-emerald-600 dark:text-emerald-400">
              <BarChart3 className="w-6 h-6" />
            </div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Production Validation Benchmark</h1>
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">
            Live quantitative verification against adversarial homonyms and synonymous paraphrasing to measure Discover vs. naive Boolean keywords.
          </p>
        </div>
      ...
      {!benchmarkResult && !running && (
        <div className="glass-card p-12 rounded-3xl border border-slate-200/80 dark:border-slate-800 text-center space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">Automated Benchmark Verification Ready</h3>
      ...
      {/* Running Indicator */}
      {running && (
        <div className="glass-card p-16 rounded-3xl border border-slate-200/80 dark:border-slate-800 text-center space-y-4">
          <RefreshCw className="w-10 h-10 animate-spin text-emerald-500 dark:text-emerald-400 mx-auto" />
          <h3 className="text-lg font-bold text-slate-900 dark:text-white">Running Adversarial Context Benchmark...</h3>
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Target &ge; 60% Reduction</span>
              ...
              <div>
                ...
                <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Missed-Coverage Reduction</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                <div className="flex justify-between">
                  <span>Naive Keyword Misses:</span>
                  <span className="font-mono text-rose-500 dark:text-rose-400">{benchmarkResult.missed_coverage_details.naive_keyword_misses} / {benchmarkResult.missed_coverage_details.corpus_size}</span>
                </div>
                <div className="flex justify-between">
                  <span>Discover Misses:</span>
                  <span className="font-mono text-emerald-600 dark:text-emerald-400">{benchmarkResult.missed_coverage_details.context_engine_misses} / {benchmarkResult.missed_coverage_details.corpus_size}</span>
                </div>
              </div>
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Target &ge; 85% Cut</span>
              ...
              <div>
                ...
                <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">False-Positive Junk Cut</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                <div className="flex justify-between">
                  <span>Naive Keyword False Positives:</span>
                  <span className="font-mono text-rose-500 dark:text-rose-400">{benchmarkResult.false_positive_details.naive_keyword_false_positives} / {benchmarkResult.false_positive_details.test_set_size}</span>
                </div>
                <div className="flex justify-between">
                  <span>Discover False Positives:</span>
                  <span className="font-mono text-emerald-600 dark:text-emerald-400">{benchmarkResult.false_positive_details.context_engine_false_positives} / {benchmarkResult.false_positive_details.test_set_size}</span>
                </div>
              </div>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-snug">
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Target &lt; 30 Min / Day</span>
                <Clock className="w-4 h-4 text-violet-500 dark:text-violet-400" />
              </div>
              <div>
                <div className="text-4xl font-black text-violet-600 dark:text-violet-400 font-mono">
                  {benchmarkResult.analyst_time_details.ce_triage_hours_per_day * 60}m <span className="text-sm font-normal text-slate-500 dark:text-slate-400">/ day</span>
                </div>
                <div className="text-xs font-bold text-slate-900 dark:text-white mt-1">Daily Analyst Triage Time</div>
              </div>
              <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
                <div className="flex justify-between">
                  <span>Previous Manual Triage:</span>
                  <span className="font-mono text-slate-700 dark:text-slate-300">4.0 hrs / day</span>
                </div>
                <div className="flex justify-between">
                  <span>Hours Saved Annually:</span>
                  <span className="font-mono text-emerald-600 dark:text-emerald-400">+{benchmarkResult.analyst_time_details.annual_hours_saved} hrs / yr</span>
                </div>
              </div>
              <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-snug">
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 dark:border-slate-800 pb-4">
              <div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white">Adversarial Disambiguation Matrix</h3>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-50 dark:bg-slate-950/60 border-b border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 uppercase tracking-wider font-mono">
                  <tr>
                    ...
                    <th className="px-4 py-3">Discover Verdict</th>
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 text-slate-700 dark:text-slate-200">
                  {benchmarkResult.false_positive_details.adversarial_results.map((item, idx) => (
                    <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-colors">
                      <td className="px-4 py-3.5 font-medium max-w-xs text-slate-800 dark:text-slate-200">
                        {item.text}
                      </td>
                      <td className="px-4 py-3.5 font-mono text-cyan-600 dark:text-cyan-400 font-bold uppercase">
                        {item.target_client}
                      </td>
                      <td className="px-4 py-3.5">
                        <span className="px-2.5 py-1 rounded bg-rose-500/10 text-rose-600 dark:text-rose-300 border border-rose-500/20 font-mono text-[11px] font-bold">
                          FALSE HIT
                        </span>
                      </td>
                      <td className="px-4 py-3.5 font-mono">
                        {item.verdict === 'not_relevant' ? (
                          <span className="px-2.5 py-1 rounded bg-emerald-500/10 text-emerald-700 dark:text-emerald-300 border border-emerald-500/20 font-bold flex items-center gap-1.5 w-fit">
                            <Check className="w-3.5 h-3.5" />
                            <span>FILTERED OUT</span>
                          </span>
                        ) : (
                          <span className="px-2.5 py-1 rounded bg-amber-500/10 text-amber-700 dark:text-amber-300 border border-amber-500/20 font-bold">
                            {item.verdict.toUpperCase()}
                          </span>
                        )}
                      </td>
                      <td className="px-4 py-3.5 text-xs text-slate-600 dark:text-slate-400 max-w-sm leading-relaxed">
                        {item.explanation}
                      </td>
                    </tr>
                  ))}
